...
const UNESCORecognition = () => {
  return (
    <>
      ...
      />
      <div className="mt-10">
      <h1 className="ml-16 font-bold text-lg md:text-xl lg:text-[23px] xl:text-[28px]  text-light-red">
      ...
      <div className="mt-10">
      <h1 className="font-bold text-lg md:text-xl lg:text-[23px] xl:text-[28px] text-light-red ml-16">
