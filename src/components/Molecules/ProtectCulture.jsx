...
const ProtectCulture = () => {
    return(
        ...
        >
            ...
            <div className="relative top-80 lg:top-24 z-10">
                <ProtectCultureMap/>
            </div>
            </div>
            <img src={gelombang} alt="" className="absolute -bottom-36 lg:-bottom-80 w-full"/>
        </div>
    )
}
