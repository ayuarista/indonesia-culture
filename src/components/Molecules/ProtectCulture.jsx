...
const ProtectCulture = () => {
    return(
        ...
        >
            ...
            <img src={gelombang} alt="" className="absolute -bottom-80 w-full"/>
        </div>
    )
}
