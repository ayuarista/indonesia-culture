    ...
    return(
        ...
        >
            <div className="absolute text-center mt-20">
                <h1 className="font-secondary text-5xl lg:text-7xl">Preserve Culture, <br /> 
            ...
            <div className="relative top-44 lg:top-24 z-10">
                <ProtectCultureMap/>
            </div>
            </div>
            <img src={gelombang} alt="" className="absolute -bottom-28 lg:-bottom-80 w-full"/>
        </div>
    )
}
