...
const ASEAN = () => {
    return(
        ...
        desc={"The ASEAN Cultural Heritage Award honors significant contributions to preserving, protecting, and promoting the rich and diverse cultural heritage of Southeast Asia."}
        />
        <ImageSlider/>
        </>
    )
