...
const CardNational = ({ image, date, views, title, sortOption, id }) => {
  return (
    <div className="flex flex-col relative mt-5">
      <div className="max-w-md lg:max-w-xl xl:max-w-md h-full p-4 rounded-t-3xl border border-gray-300 shadow-sm overflow-hidden">
      <div className="relative group bg-cover overflow-hidden">
        ...
        <div className="border-l-2 border-light-red ml-2 px-3 mt-3">
          <div className="flex items-center gap-3">
            <p className="text-gray-400 text-[13px] xl:text-sm">{date}</p>
          ...
          <div className="mt-2 font-medium text-black text-[15px] xl:text-lg text-pretty">
            {title}
          </div>
        </div>
      </div>
