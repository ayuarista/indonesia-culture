const CardCulturalAwards = () => {
    return(
        ...
        <div className="absolute left-36 bottom-10">
            <div className="w-36">
            <img src="https://images.unsplash.com/photo-1717924312594-31750e48a392?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGRheWFrfGVufDB8fDB8fHww" alt="" className="w-full object-cover border-white border-4 rounded-full"/>
            </div>
        </div>
