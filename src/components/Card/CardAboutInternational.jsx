    ...
    <div className="flex gap-7">
      <div className="relative">
        <img
          ...
          alt=""
          className="border-4 border-white rounded-tr-[80px] rounded-bl-4xl w-60 object-cover scale-x-[-1] relative"
        />
        <div className="absolute bottom-0 right-0 p-8 rounded-full border-2 border-white bg-light-red z-10"></div>
