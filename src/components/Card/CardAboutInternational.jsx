const CardAboutInternational = () => {
  return (
    <div className="flex flex-col lg:flex-row lg:gap-7 mx-8">
      ...
      <div className="relative lg:mt-10 ml-auto">
        <img
          ...
          alt=""
          className="border-4 border-white rounded-tl-[80px] rounded-br-4xl w-44 h-60 lg:w-48 lg:h-64 object-center object-cover scale-x-[-1] relative rotate-10 lg:rotate-0"
        />
