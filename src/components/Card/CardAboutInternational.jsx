    ...
    <div className="flex flex-col md:flex-row lg:flex-row lg:gap-7 mx-8">
      <div className="relative">
        <img
          ...
          alt=""
          className="border-4 border-white rounded-tr-[80px] rounded-bl-4xl w-40 md:w-56 lg:w-60 lg:h-full md:h-72 h-56 object-cover scale-x-[-1] relative"
        />
        <div className="absolute -bottom-5 right-24 lg:right-0 lg:-bottom-3 p-8 rounded-full border-8 border-white bg-light-red z-10"></div>
      ...
      <div className="relative lg:mt-10 md:ml-10 ml-auto">
        <img
          ...
          alt=""
          className="border-4 border-white rounded-tl-[80px] rounded-br-4xl w-44 h-60 md:w-48 md:h-64 lg:w-48 lg:h-64 object-center object-cover scale-x-[-1] relative rotate-10 lg:rotate-0"
        />
