const CardRRI = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center mt-20">
      <div className="relative w-full left-10 lg:left-28">
      ...
      <div className="flex flex-col w-full mt-10 lg:mt-0">
        ...
        <p className="font-medium text-black text-pretty mt-2 max-w-[30rem]">RRI, established on September 11, 1945, is Indonesia's national radio station that provides news, culture, and education. As a member of ABU, RRI plays a role in international content exchange and development of broadcasting technology. </p>
      </div>
    </div>
  );
};
