const CardPreserveCulture = ({image, title, desc}) => {
    return (
        <div className="relative max-w-md lg:max-w-sm border border-gray-300 rounded-lg p-5 hover:-translate-y-3  transition-all duration-300 ease-in-out">
            ...
            <div className="p-2">
                <p className="text-justify font-medium text-[14px] text-black mt-2">{desc}</p>
            </div>
        </div>
    )
}
