const CardTVRI = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row lg:flex-row items-center justify-center mt-16 w-full">
      ...
      <div className="relative w-full md:w-[60%] lg:w-full bg-gradient-to-r from-dark-red to-light-red h-72 rounded-tl-full">
        <div className="absolute right-8 lg:right-12 -top-10">
          <img
            ...
            className="rounded-tr-full rounded-tl-full object-cover w-60 h-60 md:w-48 lg:w-68 lg:h-68 border-8 border-white rotate-6"
            alt=""
          />
          <div className="absolute bg-white border-4 border-dashed -bottom-5 right-0 border-light-red p-7 rounded-full"></div>
        </div>
        <div className="absolute left-0 md:left-3 lg:-left-2 bottom-0">
          <img
            src="https://ambonews.com/sites/default/files/article/2024/12/WhatsApp%20Image%202024-12-20%20at%2009.37.09.jpeg"
            alt=""
            className="w-56 md:w-52 lg:w-60 object-cover rounded-tl-4xl rounded-b-4xl rounded-tr-full border-8 border-white"
          />
        </div>
      </div>
    </div>
