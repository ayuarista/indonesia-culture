    ...
    <div className="relative rounded-2xl shadow-lg bg-white">
      <div className="relative">
        ...
        <div className="absolute rounded-full px-2 py-2 bg-gradient-to-l from-dark-red to-light-red text-white font-semibold top-3 mx-2">
          <p className="text-[13px]">Remaining Days : 470 Days</p>
        </div>
      </div>
      <div className="absolute rounded-2xl bg-white h-60 top-28 bottom-0 shadow-lg">
        <div className="p-3">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-semibold text-black text-lg ">Hari Raya Nyepi</h1>
          <p className="text-sm text-justify text-gray-400">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Commodi ut
            et assumenda corrupti quibusdam nam natus. Veritatis, tenetur
            necessitatibus sed quas explicabo soluta impedit alias ut?
            Repellendus recusandae corrupti necessitatibus?
          </p>
          </div>
        </div>
      </div>
