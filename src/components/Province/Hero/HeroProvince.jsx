...
const HeroProvince = () => {
  return (
    <div
    className="w-full md:min-h-[20vh] min-h-[85vh] lg:min-h-[70vh] xl:min-h-[60vh] bg-cover bg-center flex justify-center items-center text-white bg-blend-multiply bg-black/60"
    style={{
    ...
    <div className="lg:px-6 text-center">
      <div className="mt-10">
        <div className="items-center mb-3">
          <h1 className="font-third text-white text-3xl lg:text-5xl xl:text-6xl md:text-3xl font-bold leading-tight text-center">
