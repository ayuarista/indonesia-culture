    ...
    return (
        <div className="mx-16">
            <div className="flex items-center gap-3">
                <h1 className="bg-gradient-to-r font-bold text-4xl from-0% from-[#490303] to-60% to-[#AF0808] text-transparent bg-clip-text">Indonesian Muri Record</h1>
                <img src={muri} alt="" className="w-28"/>
            </div>
