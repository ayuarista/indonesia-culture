...
const AboutNationalAward = () => {
    return(
        ...
        <div className="flex flex-col gap-1">
          <h1 className="font-bold text-3xl lg:text-4xl whitespace-pre-wrap text-pretty bg-gradient-to-r from-[#490303] from-0% to-[#AF0808] to-40% text-transparent bg-clip-text">
          Indonesian National Cultural Awards
          </h1>
        </div>
        <p className="font-medium text-sm lg:text-base mt-3 text-pretty text-justify max-w-[23rem] md:max-w-[30rem] lg:max-w-[29rem]">
