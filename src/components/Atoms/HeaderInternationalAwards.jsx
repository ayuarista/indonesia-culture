const HeaderInternationalAwards = ({image, title, desc}) => {
  return (
    <div className="flex flex-col items-center justify-center my-6">
      ...
      <h2 className="mx-4 mt-3 text-2xl md:text-3xl lg:text-3xl xl:text-4xl font-bold bg-gradient-to-r from-0% from-dark-red to-80% to-light-red bg-clip-text text-transparent text-center">
        {title}
      </h2>
