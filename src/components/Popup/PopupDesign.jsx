  ...
  return (
    visible && (
      <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-50 transition-all duration-300 ease-in-out">
        <div
          className={`bg-white rounded-lg p-6 w-[90%] max-w-3xl transform transition-all duration-500 ease-in-out ${animationClass}`}
        >
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="p-2 w-full md:w-[60%] relative">
              <div>
                <h1 className="bg-gradient-to-r from-0% to-40% from-dark-red to-light-red text-transparent bg-clip-text font-bold text-xl lg:text-xl md:text-xl text-justify text-pretty">
                  {title}
                </h1>
              ...
              <p className="font-medium text-black mt-5 text-justify text-sm lg:text-[15px]/6 mb-5">
                {desc}
              </p>
              <div className="absolute -bottom-3 right-2 lg:-bottom-2 lg:right-3 text-sm">
                <button
                  onClick={closeModal}
